;; CurateX: Decentralized Content Curation Protocol on Stacks L2
;; 
;; Summary: A community-powered platform for incentivized content curation featuring reputation-based voting, 
;;          STX rewards, and decentralized moderation - built on Bitcoin-secured Stacks Layer 2 infrastructure.
;;
;; Description: 
;; CurateX enables decentralized content discovery through collective intelligence. Users submit content with
;; STX fees, earn reputation through quality voting, and reward creators directly. Features include:
;; - Topic-based content organization with administrator-controlled categories
;; - Reputation-weighted appraisal system with Sybil-resistance
;; - Direct STX gratuity payments to content creators
;; - Community flagging system with administrator oversight
;; - Immutable audit trail using Bitcoin's security model
;; - Layer 2 efficiency with minimal transaction fees
;;
;; Designed for Bitcoin compatibility with Stacks L2 benefits: finality through Bitcoin blocks, 
;; smart contract flexibility, and native STX token integration.
